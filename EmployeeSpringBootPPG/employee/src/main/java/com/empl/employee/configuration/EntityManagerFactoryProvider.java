...
public class EntityManagerFactoryProvider {
     ...
     * are scanned for entity classes, so that the created EntityManagers know
     * about
     * them.
     */
    ...
    private static Map<String, Object> getJPAProperties(ClassLoader classLoader) {
        ...
        // connection pool.
        // http: //
        // www.eclipse.org/eclipselink/documentation/2.4/jpa/extensions/p_connection_pool.htm
