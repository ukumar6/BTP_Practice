...
import com.anubhavtrainings.dbboot.util.SpringUtils;
...
@WebServlet(urlPatterns = { "/anubhav.svc/*" }
        ...
        , initParams = {
                ...
                @WebInitParam(name = "org.apache.olingo.odata2.service.factory", value = "com.anubhavtrainings.dbboot.processor.MyODataProcessor")
        }
...
public class BuilderODataServlet extends ODataServlet {
    ...
    private String oDataServiceFactoryBeanName = "com.anubhavtrainings.dbboot.processor.MyODataServiceFactory";
